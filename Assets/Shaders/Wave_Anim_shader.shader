Shader "Gamedev/Wave_Anim_Shader"
{
	...
	Subshader
	{
		...
		{	
			...
			#include "NRMLighting.cginc"//Lighting fuctions are kept in this file.
		    ...
		    #include "CUSTOMAnims.cginc"//Animation fuctions are kept in this file.
